...
const Clock = () => {
  ...
  return (
    <div className='clock__wrapper d-flex justify-content-center align-items-center gap-3 mb-4' >
        <div className='clock__data d-flex justify-content-center align-items-center gap-3' >
